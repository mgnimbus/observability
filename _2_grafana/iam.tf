...
resource "aws_iam_policy" "gafa_irsa_s3_policy" {
...
resource "aws_iam_role" "gafa_irsa_s3_role" {
...
resource "aws_iam_role_policy_attachment" "EKSAmazonS3Role" {
  policy_arn = aws_iam_policy.gafa_irsa_s3_policy.arn
  role       = aws_iam_role.gafa_irsa_s3_role.name
}
