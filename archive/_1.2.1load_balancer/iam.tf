...
resource "aws_iam_policy" "irsa_lbc_policy" {
  name        = "${local.name}-AWSLoadBalancerControllerIAMPolicy"
  description = "To provide access to EKS to use AWS lbc services "
  ...
  "Statement": [
    {
      "Effect": "Allow",
      "Principal": {
        "Federated": "${data.terraform_remote_state.eks.outputs.oidc_provider}"
      },
